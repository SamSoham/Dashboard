  ...
  const data = {
    ...
    return(
        <div className={style.container}> 
          ...
          <p style={{fontSize:"14px",textAlign:"left"}}><span className={style.highlight}>You scored {score} question correct out of 15. </span>{score>9?"Keep it up":"However it still needs some improvement"}</p>
