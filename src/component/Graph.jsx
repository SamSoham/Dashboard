    ...
    <div className={style.container}>
      ...
      <div className={style.tag}>
        <p className={style.heading}>
          <span>Your score is {percentile}% percentile</span> which is {percentile>72?"higher":"lower"} than the average percentile 72% of all the engineers who took the assesment.
        </p>
